...
// Step 7: Handles security exceptions that occur BEFORE reaching the controller
// (i.e. at the filter chain level, not caught by @RestControllerAdvice)
@Slf4j
@Component
public class SecurityExceptionHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
    ...
    private void writeError(HttpServletResponse response, HttpStatus status,
                             String error, String message, HttpServletRequest request) throws IOException {
